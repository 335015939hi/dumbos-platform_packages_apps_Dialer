...
import com.android.dialer.common.metrics.jank.RecyclerViewJankLogger;
import com.android.dialer.common.oem.CequintCallerIdManager;
...
public class CallLogFragment extends Fragment
  ...
  public void onEmptyViewActionButtonClicked() {
    ...
    if (deniedPermissions.length > 0) {
      ...
      ActivityCompat.requestPermissions(getActivity(), deniedPermissions, PHONE_PERMISSIONS_REQUEST_CODE);
