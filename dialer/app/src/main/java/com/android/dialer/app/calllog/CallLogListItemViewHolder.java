...
import com.android.contacts.common.blocking.BlockedNumbersMigrator;
import com.android.dialer.common.filterednumbers.FilteredNumberCompat;
...
import com.android.dialer.common.clipboard.ClipboardUtils;
...
import com.android.dialer.common.contactphoto.ContactPhotoManager;
import com.android.protos.DialerContact;
import com.android.protos.SimDetails;
import com.android.dialer.common.duo.Duo;
import com.android.dialer.common.duo.DuoComponent;
import com.android.dialer.common.lettertile.LetterTileDrawable;
import com.android.dialer.common.lettertile.LetterTileDrawable.ContactType;
...
import com.android.contacts.common.phonenumbercache.CachedNumberLookupService;
import com.android.contacts.common.phonenumbercache.ContactInfo;
import com.android.contacts.common.phonenumbercache.PhoneNumberCache;
import com.android.dialer.common.phonenumberutil.PhoneNumberHelper;
import com.android.dialer.common.telecom.TelecomUtil;
import com.android.dialer.common.util.CallUtil;
import com.android.dialer.common.util.DialerUtils;
import com.android.dialer.common.util.UriUtils;
...
public final class CallLogListItemViewHolder extends RecyclerView.ViewHolder
  ...
  private void maybeShowBlockNumberMigrationDialog(BlockedNumbersMigrator.Listener listener) {
    if (!MigrateBlockedNumbersDialogFragment.maybeShowBlockNumberMigrationDialog(
        context, ((AppCompatActivity) context).getSupportFragmentManager(), listener)) {
      listener.onComplete();
    }
  }
