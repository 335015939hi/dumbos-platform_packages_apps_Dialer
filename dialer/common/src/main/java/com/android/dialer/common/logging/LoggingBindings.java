...
package com.android.dialer.common.logging;
...
import com.android.protos.PeopleApiLookupError;
...
public interface LoggingBindings {
   ...
   * @see com.android.protos.InteractionEvent
   */
   ...
   * @see com.android.protos.ScreenEvent
   */
  void logScreenView(com.android.protos.ScreenEvent.Type screenEvent, Activity activity);
