...
public final class ActivityRequestCodes {
  ...
  /** Request code for {@link com.android.dialer.common.callcomposer.CallComposerActivity} intent. */
  public static final int DIALTACTS_CALL_COMPOSER = 2;

  /** Request code for {@link com.android.dialer.common.duo.Duo#getCallIntent(String)}. */
  public static final int DIALTACTS_DUO = 3;

  /** Request code for {@link com.android.dialer.common.calldetails.OldCallDetailsActivity} intent. */
  public static final int DIALTACTS_CALL_DETAILS = 4;

  /**
   * Request code for {@link com.android.dialer.common.speeddial.SpeedDialFragment} contact picker intent.
   */
