...
package com.android.dialer.common.location;
...
public class CountryDetector {
  ...
  private static void registerForLocationUpdates(Context context, LocationManager locationManager) {
    ...
    final PendingIntent pendingIntent =
        PendingIntent.getBroadcast(context, 0, activeIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);
